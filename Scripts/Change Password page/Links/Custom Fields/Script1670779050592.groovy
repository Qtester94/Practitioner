...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Custom Fields'))

link_event = WebUI.getUrl()

WebUI.verifyMatch(link_event, 'https://opensource-demo.orangehrmlive.com/web/index.php/pim/listCustomFields', false)
