...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_Enabled_oxd-icon bi-trash'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_No, Cancel'))

WebUI.verifyTextPresent('System Users', false)
