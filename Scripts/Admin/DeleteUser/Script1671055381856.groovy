...
WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/i_Enabled_oxd-icon bi-trash'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/button_Yes, Delete'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_SuccessSuccessfully Deleted'), 0)
