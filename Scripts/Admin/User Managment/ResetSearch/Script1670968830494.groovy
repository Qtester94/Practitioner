...
WebUI.setText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 'Test')

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/button_Reset'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input_Username_oxd-input oxd-input--active'), 
    '')
