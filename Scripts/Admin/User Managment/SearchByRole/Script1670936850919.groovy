...
WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_System Users_--toggle'))

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/i_System Users_oxd-icon bi-caret-down-fill'))

WebUI.click(findTestObject('Admin/Page_OrangeHRM/div_-- Select --'))

WebUI.click(findTestObject('Admin/Admin'))

//WebUI.setText(findTestObject('Admin/Page_OrangeHRM/div_-- Select --'), 'Admin')
//WebUI.delay(10)
...
WebUI.click(findTestObject('Admin/ESS'))

//WebUI.setText(findTestObject('Admin/Page_OrangeHRM/div_-- Select --'), 'Admin')
//WebUI.delay(10)
WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/button_Search'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_Admin'), 'ESS')
