...
WebUI.setText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 'Admin')

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/button_Search'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/span_(1) Record Found'), '(1) Record Found')

WebUI.verifyElementPresent(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_Employee NamePaul CollingsUsernameAdmin_fb625b'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_Admin'), 'Admin')
