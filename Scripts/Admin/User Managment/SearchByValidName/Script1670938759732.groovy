...
WebUI.setText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input'), 'Alice')

WebUI.click(findTestObject('Admin/Ewerton'))

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/button_Search'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_Max Max'), 'Alice Duval')
