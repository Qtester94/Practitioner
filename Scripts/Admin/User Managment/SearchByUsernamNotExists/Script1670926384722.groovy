...
WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_System UsersUsernameUser Role-- Select _3559ba'))

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/i_System Users_oxd-icon bi-caret-down-fill'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 'TTTTTTTT')

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/button_Search'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_InfoNo Records Found'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/span_No Records Found'), 'No Records Found')
