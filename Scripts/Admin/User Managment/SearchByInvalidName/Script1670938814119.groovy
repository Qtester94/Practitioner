...
WebUI.setText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input'), 'ttttttttttttttttt')

WebUI.delay(3)

WebUI.verifyTextPresent('No Records Found', false)

//WebUI.verifyElementPresent(findTestObject('Object Repository/Admin/Page_OrangeHRM/span_Invalid'), 0)
//WebUI.verifyElementText(findTestObject('Object Repository/Admin/Page_OrangeHRM/span_Invalid'), 'Invalid')
WebUI.closeBrowser()
