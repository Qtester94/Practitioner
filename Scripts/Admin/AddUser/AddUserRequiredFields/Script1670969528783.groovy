...
WebUI.verifyElementText(findTestObject('Admin/RequiredRole'), 'Required')

WebUI.verifyElementText(findTestObject('Admin/Page_OrangeHRM/RequiredName'), 'Required')

WebUI.verifyElementText(findTestObject('Admin/Page_OrangeHRM/RequiredStatus'), 'Required')

WebUI.verifyElementText(findTestObject('Admin/Page_OrangeHRM/RequiredUsername'), 'Required')

WebUI.verifyElementText(findTestObject('Admin/Page_OrangeHRM/RequiredConfirmPass'), 'Required')
