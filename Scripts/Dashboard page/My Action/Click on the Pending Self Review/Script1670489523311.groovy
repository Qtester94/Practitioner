...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/p_(1) Pending Self Review'))

link_event = WebUI.getUrl()

WebUI.verifyMatch(link_event, 'https://opensource-demo.orangehrmlive.com/web/index.php/performance/myPerformanceReview', 
    false)
