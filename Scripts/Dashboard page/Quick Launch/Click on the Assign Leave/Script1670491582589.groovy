...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/path_Today_cls-1'))

link_event = WebUI.getUrl()

WebUI.verifyMatch(link_event, 'https://opensource-demo.orangehrmlive.com/web/index.php/leave/assignLeave', false)
