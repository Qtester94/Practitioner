...
WebUI.click(findTestObject('Object Repository/NavigationBar/Page_OrangeHRM/a_PIM'))

link_event = WebUI.getUrl()

WebUI.verifyMatch(link_event, 'https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewEmployeeList', false)
